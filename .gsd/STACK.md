...
- GitHub Project: número 4 (`PVT_kwHOB3_Pfc4Bi462`), owner `MatheusSlvRibeiro`. Campo `Status` (`PVTSSF_lAHOB3_Pfc4Bi462zhhvUUQ`) com as 6 colunas padrão (Backlog `fddc6b51`, Ready `6e3d4bce`, Priority `aca5a519`, In Progress `58321daf`, In Review `d5262a85`, Done `13d7381e`). Campo de tipo chamado **`Task Type`**, não `Type` — o nome `Type` é reservado pelo GitHub Projects (feature nativa de "Issue Type"). IDs das opções de `Task Type`: feat `42025a48`, fix `b0718dc8`, chore `dc6bd021`, refactor `7340a8b6`, test `a8fdb4a0`, docs `7bdd9481`.
